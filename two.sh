...
#-----------------------------------------------
#Permissions and Ownership + additional task
...
# Define the correct user and group names
user_name="sandhya"  # Change to your actual username if different
group_name="sandhya" # Change to your group if different
